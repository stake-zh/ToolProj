...
public class DisplayUtil {
    ...
    private static WindowManager getWindowManager() {
        if (windowManager == null) {
            windowManager = (WindowManager) ApplicationStatus.getApplicationContext().getSystemService(Context.WINDOW_SERVICE);
        }
    ...
    public static float dip2pxFloat(float dp) {
        try {
            DisplayMetrics metrics = ApplicationStatus.getApplicationContext().getResources().getDisplayMetrics();
